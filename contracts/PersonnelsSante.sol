...
contract PersonnelsSante {
    ...
    function getRolePersonnel(uint256 idPersonnel) public view returns (string memory) {
        PersonnelSante storage tmp = PersonnelSante_Struct[idPersonnel];
        return tmp.rolePersonnel;
    }

    function getNomPersonnel(uint256 idPersonnel) public view returns (string memory) {
        PersonnelSante storage tmp = PersonnelSante_Struct[idPersonnel];
        return tmp.nomPersonnel;
    }

    function getPrenomPersonnel(uint256 idPersonnel) public view returns (string memory) {
        PersonnelSante storage tmp = PersonnelSante_Struct[idPersonnel];
        return tmp.prenomPersonnel;
    }

    function getMailPersonnel(uint256 idPersonnel) public view returns (string memory) {
        PersonnelSante storage tmp = PersonnelSante_Struct[idPersonnel];
